...
export const PERMISSIONS = {
  ...
  PRINT_VIEW_QUOTATIONS: 'print_view_quotations',
  ...
  PRINT_ACTIVE_QUOTATIONS: 'print_active_quotations',
  ...
  PRINT_PENDING_QUOTATIONS: 'print_pending_quotations',
  ...
  PRINT_CANCELLED_QUOTATIONS: 'print_cancelled_quotations',
  ...
  PRINT_PENDING_WORKSTARTED: 'print_pending_workstarted',
  ...
  PRINT_HANDOVER_OVERDUE: 'print_handover_overdue',
  ...
  PRINT_INVOICE_SUBMITTED: 'print_invoice_submitted',
  ...
  PRINT_RETENTION_INVOICE_PENDING: 'print_retention_invoice_pending',
  ...
  PRINT_RETENTION_INVOICE_OVERDUE: 'print_retention_invoice_overdue',
  ...
  PRINT_RETENTION_INVOICE_SUBMITTED: 'print_retention_invoice_submitted',
};
