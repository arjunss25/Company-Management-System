  ...
  const [quotations] = useState([
    {
      id: 1,
      date: '18-Nov-2024',
      referenceNo: 'zxcdsc-QTN-34-1124',
      client: 'Divya M',
      location: 'asdsda',
      amount: 0,
    },
    {
      id: 2,
      date: '18-Nov-2024',
      referenceNo: 'zxcdsc-QTN-35-1124',
      client: 'Divya M',
      location: 'asdsda',
      amount: 37478556,
    },
                ...
                <tbody>
                  {quotations.map((quotation, index) => (
                    ...
                    >
                      ...
                      <td className="px-8 py-5 text-gray-700 whitespace-nowrap">{quotation.referenceNo}</td>
