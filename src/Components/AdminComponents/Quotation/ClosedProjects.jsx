...
const ClosedProjects = () => {
  ...
  const handlePrintPDF = async (quotationId) => {
    if (hasPermission(PERMISSIONS.EXPORT_CLOSED_PROJECTS)) {
      try {
  ...
  const handleCancel = (quotation) => {
    if (hasPermission(PERMISSIONS.DELETE_CLOSED_PROJECTS)) {
  ...
  const handleEdit = (quotation) => {
    if (hasPermission(PERMISSIONS.EDIT_CLOSED_PROJECTS)) {
  ...
  const handleApplyDateFilters = async (filters) => {
    try {
      ...
      const response = await axiosInstance.get(
        `/filter-closedproject-by-date/${formatDateForApi(
          filters.dateFrom
                          ...
                          <div className="flex items-center space-x-4">
                            <motion.button
                              ...
                              data-tooltip-content={
                                !hasPermission(PERMISSIONS.EDIT_CLOSED_PROJECTS)
                                  ? "You don't have permission to edit closed projects"
                                  : ''
                              }
                              whileHover={
                                hasPermission(PERMISSIONS.EDIT_CLOSED_PROJECTS)
                            ...
                            <motion.button
                              ...
                              data-tooltip-content={
                                !hasPermission(
                                  PERMISSIONS.DELETE_CLOSED_PROJECTS
                                )
                                  ? "You don't have permission to cancel closed projects"
                                  : ''
                              }
                              whileHover={
                                hasPermission(
                            ...
                            <motion.button
                              ...
                              data-tooltip-content={
                                !hasPermission(
                                  PERMISSIONS.EXPORT_CLOSED_PROJECTS
                                )
                                  ? "You don't have permission to export closed projects"
