...
const Onhold = () => {
  ...
  const fetchQuotations = async () => {
    try {
      ...
      const response = await axiosInstance.get('/list-on-hold-work-status/', {
        params,
      });
  ...
  const handleApplyDateFilters = async (filters) => {
    try {
      ...
      const response = await axiosInstance.get(
        `/filter-onholdwork-by-date/${formatDateForApi(
          filters.dateFrom
            ...
            <div className="overflow-x-auto">
              {loading ? (
                ...
                <div className="flex flex-col items-center justify-center min-h-[300px] text-gray-500">
                  ...
                  <p className="text-xl font-medium">No On Hold Quotations</p>
                  {dateFilters.dateFrom && dateFilters.dateTo ? (
