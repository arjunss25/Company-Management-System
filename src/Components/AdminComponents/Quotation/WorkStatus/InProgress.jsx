                ...
                <tbody>
                  {quotations.map((quotation, index) => (
                    ...
                    >
                      ...
                      <td className="px-8 py-5 text-gray-700 whitespace-nowrap">{quotation.buildingName}</td>
                      <td className="px-8 py-5 text-gray-700 whitespace-nowrap">{quotation.buildingNo}</td>
