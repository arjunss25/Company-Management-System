...
const InProgress = () => {
  ...
  const handlePrintPDF = async (quotationId) => {
    if (hasPermission(PERMISSIONS.EXPORT_IN_PROGRESS)) {
      try {
  ...
  const handleCancel = (quotation) => {
    if (hasPermission(PERMISSIONS.DELETE_IN_PROGRESS)) {
  ...
  const handleEdit = (quotation) => {
    if (hasPermission(PERMISSIONS.EDIT_IN_PROGRESS)) {
    ...
    <div className="flex">
      <div className="flex-1 md:w-[calc(100%-300px)]">
        ...
        <h1 className="text-3xl font-bold text-gray-900 tracking-tight text-center">
          Quotations Work Status - In Progress
        </h1>
        {/* Date Filter */}
                        ...
                        <div className="flex items-center space-x-4">
                          <motion.button
                            ...
                            data-tooltip-content={
                              !hasPermission(PERMISSIONS.EDIT_IN_PROGRESS)
                                ? "You don't have permission to edit in-progress quotations"
                                : ''
                            }
                            whileHover={
                              hasPermission(PERMISSIONS.EDIT_IN_PROGRESS)
                          ...
                          <motion.button
                            data-tooltip-id="action-tooltip"
                            data-tooltip-content={
                              !hasPermission(PERMISSIONS.DELETE_IN_PROGRESS)
                                ? "You don't have permission to cancel in-progress quotations"
                                : ''
                            }
                            whileHover={
                              hasPermission(PERMISSIONS.DELETE_IN_PROGRESS)
                          ...
                          <motion.button
                            data-tooltip-id="action-tooltip"
                            data-tooltip-content={
                              !hasPermission(PERMISSIONS.EXPORT_IN_PROGRESS)
                                ? "You don't have permission to export in-progress quotations"
