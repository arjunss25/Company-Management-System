...
const EditProductDetails = ({ optionValue }) => {
  ...
  const [productsByOption, setProductsByOption] = useState({
    'Default Products': [
      [
        { id: 1, name: 'Product 1', description: 'Description of Product 1', photo: 'photo1.jpg', brand: 'Brand A', location: 'Location 1', itemCode: 'IC001', workOrderNumber: 'WO001', referenceNumber: 'REF001', unit: 'Unit 1', quantity: 10, unitprice: 100, amount: 1000 },
        { id: 2, name: 'Product 2', description: 'Description of Product 2', photo: 'photo2.jpg', brand: 'Brand B', location: 'Location 2', itemCode: 'IC002', workOrderNumber: 'WO002', referenceNumber: 'REF002', unit: 'Unit 2', quantity: 5, unitprice: 200, amount: 1000 },
        { id: 3, name: 'Product 3', description: 'Description of Product 3', photo: 'photo3.jpg', brand: 'Brand C', location: 'Location 3', itemCode: 'IC003', workOrderNumber: 'WO003', referenceNumber: 'REF003', unit: 'Unit 3', quantity: 8, unitprice: 150, amount: 1200 },
      ],
    ],
  });
  ...
  const handleColumnToggle = (columnName) => {
    setSelectedColumns((prev) => {
      ...
      // Update productsByOption to reflect the new columns
      setProductsByOption((prevProducts) => {
        const updatedProducts = { ...prevProducts };
        Object.keys(updatedProducts).forEach((option) => {
          updatedProducts[option] = updatedProducts[option].map((table) =>
            table.map((product) => {
              const newProduct = { ...product };
              if (!newSelectedColumns[columnName]) {
                delete newProduct[columnName.toLowerCase()];
              }
              return newProduct;
            })
          );
