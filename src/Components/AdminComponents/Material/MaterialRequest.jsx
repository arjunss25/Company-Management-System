  ...
  const [requests] = useState([
    {
      ...
      workNo: 'zxcdsc-QTN-11-1024',
      status: 'Pending',
    },
    {
      id: 2,
      requestedBy: 'Jane Smith',
      workNo: 'zxcdsc-QTN-14-1024',
      status: 'Approved',
    },
    {
      id: 3,
      requestedBy: 'Mike Johnson',
      workNo: 'zxcdsc-QTN-16-1024',
      status: 'Rejected',
    },
                ...
                <tbody>
                  {requests.map((request, index) => (
                    ...
                    >
                      ...
                      <td className="px-8 py-5">
                        <span className="text-gray-700">{request.workNo}</span>
                      </td>
                      <td className="px-8 py-5">
                        <motion.button
                          ...
                          onClick={() =>
                            navigate(`/material-request-details/${request.id}`)
                          }
                        >
                          View
                        </motion.button>
