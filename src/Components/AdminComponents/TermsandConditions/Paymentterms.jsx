...
const Paymentterms = () => {
  ...
  const termsData = [
    { id: 1, terms: '50% advance payment required' },
    { id: 2, terms: 'Balance payment within 15 days of delivery' },
    { id: 3, terms: 'Late payment fee of 2% per month' },
    { id: 4, terms: 'All payments via bank transfer only' },
    { id: 5, terms: 'GST will be charged as applicable' },
  ];
    ...
    <div className="flex h-screen bg-gray-50">
          ...
          <div className="relative bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-200">
            <div className="overflow-x-auto">
              <table className="w-full min-w-[600px]">
                {/* ... table header and body structure same as GeneralTermsandCondition ... */}
                <thead>
                ...
                <tbody>
                  {termsData.map((term, index) => (
                    ...
                    >
                      {/* ... table row content same as GeneralTermsandCondition ... */}
      ...
      {isEditModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          ...
          >
            {/* ... edit modal content same as GeneralTermsandCondition ... */}
      ...
      {isDeleteModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <motion.div
            ...
            className="bg-white rounded-xl shadow-lg max-w-md w-full p-6"
          >
            {/* ... delete modal content same as GeneralTermsandCondition ... */}
