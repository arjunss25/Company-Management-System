...
const GeneralTermsandCondition = () => {
  ...
  const termsData = [
    { id: 1, terms: 'Payment should be made within 30 days' },
    { id: 2, terms: 'Delivery within 7 working days' },
    { id: 3, terms: 'Warranty valid for 1 year' },
    { id: 4, terms: 'Free installation included' },
    { id: 5, terms: 'Return policy valid for 10 days' },
  ];
